...
final class TopupInteractorTests: XCTestCase {
    ...
    func testActivate() {
        // given
        let cards = [
            PaymentMethod(id: "0", name: "Zero", digits: "1234", color: "", isPrimary: false)
        ]
    ...
    func testDidAddCardWithCard() {
        ...
        let newCard = PaymentMethod(id: "new_card_id", name: "New Card", digits: "0000", color: "", isPrimary: false)
    ...
    func testDidSelectCard() {
        ...
        let cards = [
            PaymentMethod(id: "0", name: "Zero", digits: "0123", color: "", isPrimary: false),
            PaymentMethod(id: "1", name: "One", digits: "1234", color: "", isPrimary: false),
        ]
        cardOnFileRepository.cardOnFileSubject.send(cards)
